...
export const ConfirmTeamEmailTemplate = ({
  ...
  const previewText = msg`Accept team email request for ${teamName} on eSign Center`;
            ...
            <Section className="p-2 text-slate-500">
              ...
              <Text className="text-center text-base">
                <Trans>
                  ...
                  address for their team on eSign Center.
                </Trans>
              </Text>
              ...
              <Section className="mt-6">
                ...
                <Text className="mt-2 text-sm">
                  <Trans>
                    You can revoke access at any time in your team settings on eSign Center{' '}
