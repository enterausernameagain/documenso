...
export const OrganisationAccountLinkConfirmationTemplate = ({
  ...
  const previewText =
    type === 'create'
      ...
      : msg`A request has been made to link your eSign Center account`;
        ...
        <Section className="bg-white">
          <Container className="mx-auto mb-2 mt-8 max-w-xl rounded-lg border border-solid border-slate-200 px-2 pt-2 backdrop-blur-sm">
            {branding.brandingEnabled && branding.brandingLogo ? (
              <Img src={branding.brandingLogo} alt="Branding Logo" className="mb-4 h-9 p-2" />
            ) : (
              <TemplateImage
                assetBaseUrl={assetBaseUrl}
                className="mb-4 h-9 p-2"
                staticAsset="red-favcon.png"
              />
            )}
            ...
            <Section className="p-2 text-slate-500">
              <Text className="text-center text-lg font-medium text-black">
                {type === 'create' ? (
                  ...
                  <Trans>Link your eSign Center account</Trans>
                )}
              </Text>
              ...
              <Text className="text-center text-base">
                {type === 'create' ? (
                  ...
                  <Trans>
                    ...
                    current eSign Center account to their organisation.
                  </Trans>
                )}
              </Text>
              ...
              {/* <Section className="mt-6">
                ...
                <Text className="mt-2 text-sm">
                  <Trans>
                    You can unlink your account at any time in your security settings on eSign Center{' '}
