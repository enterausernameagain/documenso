      ...
      <div className="w-screen max-w-lg px-4">
        <div className="flex w-full items-start">
          ...
          <div>
            ...
            <p className="mt-4 text-muted-foreground">
              <Trans>
                Your email has been successfully confirmed! You can now use all features of eSign
                Center.
              </Trans>
            </p>
      ...
      <div className="w-screen max-w-lg px-4">
        <div className="flex w-full items-start">
          ...
          <div>
            ...
            <p className="mt-4 text-muted-foreground">
              <Trans>
                Your email has already been confirmed. You can now use all features of eSign Center.
              </Trans>
            </p>
