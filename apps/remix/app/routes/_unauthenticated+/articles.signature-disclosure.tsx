  ...
  return (
    <div>
      <article className="prose dark:prose-invert">
        ...
        <p>
          <Trans>
            Thank you for using eSign Center to perform your electronic document signing. The
        ...
        <p>
          <Trans>
            By proceeding to use the electronic signature service provided by eSign Center, you
