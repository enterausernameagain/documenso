...
export function meta({ params: { slug } }: Route.MetaArgs) {
  ...
  return [
    { title: 'eSign Center - Share' },
    { description: 'I just signed a document in style with eSign Center!' },
    {
      property: 'og:title',
      content: 'eSign Center - Join the open source signing revolution',
    },
    {
      property: 'og:description',
      content: 'I just signed with eSign Center!',
    },
    {
      property: 'og:type',
      content: 'website',
...
export const loader = async ({ request, params: { slug } }: Route.LoaderArgs) => {
  ...
  // Is hardcoded because this whole meta is hardcoded anyway for eSign Center.
