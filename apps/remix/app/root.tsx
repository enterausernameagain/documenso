...
export function LayoutContent({ children }: { children: React.ReactNode }) {
  ...
  return (
    <html translate="no" lang={lang} data-theme={theme} className={theme ?? ''}>
      <head>
        <meta charSet="utf-8" />
        <link rel="apple-touch-icon" sizes="180x180" href="/red-favcon.png" />
        <link rel="icon" type="image/png" sizes="32x32" href="/red-favcon.png" />
        <link rel="icon" type="image/png" sizes="16x16" href="/red-favcon.png" />
