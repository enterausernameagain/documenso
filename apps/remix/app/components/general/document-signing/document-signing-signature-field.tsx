...
export const DocumentSigningSignatureField = ({
  ...
  return (
    ...
    >
      ...
      {state === 'empty' && (
        <p className="font-signature text-[clamp(0.575rem,25cqw,1.2rem)] text-xl text-muted-foreground duration-200 group-hover:text-primary group-hover:text-recipient-blue">
